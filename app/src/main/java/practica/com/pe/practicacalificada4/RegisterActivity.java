...
public class RegisterActivity extends AppCompatActivity {
    ...
    public void callRegister(View view) {
        ...
        if (mediaFileUri == null) {
            ...
            call = service.createDenuncia(titulo,comentario,1);
        } else {
            ...
            RequestBody usuarios_idPart = RequestBody.create(MultipartBody.FORM, "1");


            call = service.createDenunciaWithImage(tituloPart, comentarioPart, usuarios_idPart, imagenPart);
